                        ...
                        <tbody id="tbody_form">
                            <tr class="tr_form">
                                ...
                                <td>
                                    ...
                                    <input type="text" id="nasc" name="nasc" maxlength="10" placeholder="aaaa/mm/dd">
                                </td>
                                <td>
                                    <label>CPF</label>
                                    <input type="text" id='cpf' name="cpf" maxlength="14" placeholder="123.456.789-10">
                                </td>
                                <td>
                                    <label>Gênero</label>
                                    <select name="genero" >
                            ...
                            <tr class="tr_form">
                                <td>
                                    <label>Celular</label>
                                    <input type="text" id="cell" name="cell" maxlength="15"  placeholder="(DDD) 99999-9999">
                                </td>
                                <td>
                                    <label>E-mail</label>
